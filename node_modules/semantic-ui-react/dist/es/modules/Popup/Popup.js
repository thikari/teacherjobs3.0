...
var Popup = function (_Component) {
  ...
  _createClass(Popup, [{
    ...
    value: function setPopupStyle() {
      ...
      var positions = _without(POSITIONS, positioning);
    ...
    value: function render() {
      ...
      var classes = cx('ui', positioning, size, useKeyOrValueAndKey(wide, 'wide'), useKeyOnly(basic, 'basic'), useKeyOnly(flowing, 'flowing'), useKeyOnly(inverted, 'inverted'), 'popup transition visible', className);
